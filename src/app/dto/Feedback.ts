export class Feedback {
  ...
  constructor(feedDate: string, feedTime: string, feedbackMessage: string, itemAsDescribe_Rate: number, communicationRate: number, shippingTimeRate: number, shippingHandlingRate: number, id: number, feedbackOrderId: number) {
